...
func init() {
	...
	defaultTheme.setValue("window.focused.fg", ColorBlack)
	defaultTheme.setValue("window.focused.bg", ColorWhite)
	defaultTheme.setValue("window.focused.shadow", LineTransparent)
	defaultTheme.setValue("window.focused.shadow.fg", ColorBlack)
	defaultTheme.setValue("window.focused.border", LineSingle)
	defaultTheme.setValue("window.focused.border.fg", ColorBlack)
	defaultTheme.setValue("window.focused.border.bg", ColorWhite)
	defaultTheme.setValue("window.focused.title.fg", ColorRed)
	defaultTheme.setValue("window.focused.title.bg", ColorWhite)
